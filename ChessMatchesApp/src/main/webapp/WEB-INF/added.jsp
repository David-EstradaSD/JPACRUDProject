...
<body>
        ...
        <h5>The Chess Match with ID ${match.id} has been successfully added in the database.</h5>
         </c:if>
         
         <c:if test="${empty match }">
        <h1 class="successTitle">Failure</h1>
         <h4>The Chess Match was NOT successfully added in the database. Please try again.</h4>>
          </c:if>
